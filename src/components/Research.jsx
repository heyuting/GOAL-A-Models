            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                ...
                <div className="flex flex-col h-full px-12 pt-12 justify-between">
                  ...
                  <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm mt-8">
                    Get Involved
                  </button>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                <div className="flex flex-col h-full px-12 pt-12 justify-between">
                  ...
                  <div className="flex-1 flex flex-col justify-center"><p className="text-gray-700 leading-relaxed">
                  We will determine the fate of alkalinity from ERW and OAE in coastal regions, quantify carbon transport to the open ocean, and evaluate the efficiency of these approaches (when implemented separately or simultaneously) at sequestering carbon on decadal and multi-decadal timescales. We will use a suite of regional ocean biogeochemical models (MOM6-COBALT, CROCO-ROMS, MITgcm, and E3SM), designed to resolve key CO2 dynamics and river loadings in a high-resolution regional configuration of the northwest Atlantic (including the Gulf of Mexico and northeast US).                  </p></div>
                  <button className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors text-sm mt-8">
                    Get Involved
                  </button>
                </div>
                <div className="h-full">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                <div className="flex flex-col h-full px-12 pt-12 justify-between">
                  ...
                  <button className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors text-sm mb-8">
                    Get Involved
                  </button>
                </div>
                <div className="h-full">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                ...
                <div className="flex flex-col h-full px-12 pt-12 justify-between">
                  ...
                  <button className="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition-colors text-sm mt-8">
                    Get Involved
                  </button>
                </div>
              </div>
